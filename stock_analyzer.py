...
# Laaja lista seurattavia osakkeita: USA, Eurooppa, Pohjoismaat
WATCHLIST = [
    # US - Mega cap tech
    ...
    "XOM", "CVX", "OXY",
    # US - Consumer & Retail
    "WMT", "COST", "NKE", "MCD", "SBUX",
    # US - Industrial & Defence
    "BA", "LMT", "RTX", "CAT",
    # US - ETFs / indices
    "SPY", "QQQ", "IWM",
    # European & Nordic
    "ASML", "SAP", "NESTE.HE", "NOKIA.HE", "FORTUM.HE", "SAMPO.HE",
    "STOR-B.ST", "VOLV-B.ST", "ERIC-B.ST",
    # Crypto-adjacent
    "COIN", "MSTR",
]
